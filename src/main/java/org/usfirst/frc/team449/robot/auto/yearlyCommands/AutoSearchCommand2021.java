...
/**
 * The class that runs the autonomous command for the Galactic Search challenge in 2021.
 * The logic for that challenge was really complicated and the easiest implementation was this.
 */
@JsonTypeInfo(
...
public class AutoSearchCommand2021 extends SequentialCommandGroup {
     ...
     * @param feederCommand The counting command, to be used as a {@link java.util.function.BooleanSupplier}
     */
    @JsonCreator
    public AutoSearchCommand2021(@JsonProperty(required = true) Command goToCol3,
